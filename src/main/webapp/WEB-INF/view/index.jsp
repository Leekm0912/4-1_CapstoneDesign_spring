...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            -->
                <div class="sidebar-brand-text mx-3">모터 이상감지</div>
            </a>
                        ...
                        <div class="col-xl-12 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">실시간 이상감지 그래프</h6>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">이상치감지여부
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">감지</div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
